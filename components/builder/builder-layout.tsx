      ...
      <div className="grid gap-8 lg:grid-cols-2 lg:gap-10 xl:gap-14">
        ...
        <aside className="order-2 lg:order-none lg:col-start-1 lg:row-start-1">
          <div className="lg:sticky lg:top-24">
            <div className="mb-4 text-center lg:mb-6 lg:text-start">
              <p className="eyebrow-label text-accent-via">{builder.livePreview}</p>
        ...
        <div className="order-1 lg:order-none lg:col-start-2 lg:row-start-1">
          <div className="rounded-2xl border border-border bg-surface-elevated/50 p-5 sm:p-6 lg:p-8">
            <BuilderForm />
          </div>
        </div>
      </div>
